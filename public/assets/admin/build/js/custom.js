...
// Đảm bảo gọi hàm khi trang load xong
$(document).ready(function () {
    init_chart_doughnut();
});
...
function init_morris_charts() {
    ...
    if ($('#graph_bar').length && typeof window.monthlyRevenueData !== 'undefined') {

    Morris.Bar({
        element: 'graph_bar',
        data: window.monthlyRevenueData,
        xkey: 'month',
        ykeys: ['revenue'],
        labels: ['Doanh thu'],
        barRatio: 0.4,
        ...
        yLabelFormat: function (y) {
            return y.toLocaleString('vi-VN') + ' đ';
        }
    });
